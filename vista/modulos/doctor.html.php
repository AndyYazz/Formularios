    ...
    <div class="row">
        ...
        <div class="col-12">
         ...
         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
            <p1 class="datos">Nombre:</p1> <span><p2 class="obligatorio">*obligatorio</p2></span>
             <input type="text" id="nombreDoctor" class="form-control" placeholder="Nombre">
        </div>
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-4">
            <p1 class="datos">Fecha de nacimiento:</p1> <span><p2 class="obligatorio">*obligatorio</p2></span>
             <input type="text" id="fechaNacimiento" class="form-control" placeholder="AAAA/MM/DD">
        </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-4">
            <p1 class="datos">Telefono local:</p1>
             <input type="text" id="telefonoLocal"class="form-control">
        </div>

        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-4">
            <p1 class="datos">Telefono movil:</p1>
             <input type="text" id="telefonoMovil"class="form-control">
        </div>

        
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-4">
            <p1 class="datos">CURP:</p1>
             <input type="text" id="curp"class="form-control" placeholder="GACA970303HMDFR">
        </div>

        
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-4">
            <p1 class="datos">Especialidades:</p1>
             <input type="text" id="especialidades"class="form-control" placeholder="Dermatología, denista, cirujano">
        </div>
